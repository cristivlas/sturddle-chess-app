...
if __name__ == '__main__':
    test_cases = [
        ...
        [
            "dxc8=R+",
            "pawn to c8, promoting to rook, check"
        ],
        [
            "dxc8=R# !!!",
            "pawn to c8, promoting to rook, checkmate !!!"
        ],
        [
            "1. e4 e5 2. Nf3 Nc6",
            "pawn to e4 pawn to e5 knight to f3 knight to c6"
        ],
        [
            "3. Bxf7+ Kxf7",
            "bishop to f7, check king to f7"
        ],
        [
            "4. exd5!",
            "pawn to d5!"
    ...
    for test, expected in test_cases:
        translation = substitute_chess_moves(test)
