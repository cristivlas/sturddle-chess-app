...
<string name="clearanceDescription">Clear square, file, or diagonal for a tactical idea.</string>
...
<string name="discoveredAttackDescription">Discovered attack by moving a blocking piece.</string>
...
<string name="hangingPieceDescription">Tactic with an undefended opponent piece, free to be captured.</string>
...
<string name="quietMoveDescription">Neither check or capture, prepare hidden threat.</string>
